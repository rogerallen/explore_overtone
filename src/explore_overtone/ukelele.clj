...
(def eukelele-string-notes (map note [:g4 :c4 :e4 :a4]))

;; ======================================================================
;; Main helper functions.  Use pick or strum to play the ukelele instrument.
(def pick (partial pick-string eukelele-string-notes))
(def strum (partial strum-strings ukelele-chord-frets eukelele-string-notes))

...
;; ======================================================================
;; A stringed instrument with distortion, reverb and a low-pass filter.
...
;; 6-string guitar example:
;;   (gen-stringed-inst guitar6 6)
;;   (def g (guitar6))
...
;;(macroexpand-1 '(gen-stringed-inst guitar6 6))
;;(macroexpand '(gen-stringed-inst guitar6 6))
;;(gen-stringed-inst guitar6 6)
...
;; ======================================================================
;; Main helper functions.  See guitar_example.clj for how to use pick or strum to
;; play the instrument.
(defn pick-string
